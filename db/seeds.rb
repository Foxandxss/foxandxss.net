...
#
#PageImage.create(title: "Lego", content: "Lego plane on a workshop", asset: URI.parse("http://flickholdr.com/600/400"), page: page)
...
##PageImage.create(asset: URI.parse("http://placehold.it/1024x768/4D99E0/ffffff.png&text=1024x768"), page: page) # It's usually down
#PageImage.create(asset: Rails.root.join("spec/fixtures/project1.png").open, page: page)
#
...
#
#News.create!(title: "Newer news", content: Faker::Lorem.paragraphs(3), image: URI.parse("http://placekitten.com/580/150"))
#News.create!(title: "Newer news", content: Faker::Lorem.paragraphs(3), image: URI.parse("http://placekitten.com/580/380"))
#News.create!(title: "Newer news", content: Faker::Lorem.paragraphs(3), image: URI.parse("http://placekitten.com/250/120"))
